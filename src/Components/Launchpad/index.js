        ...
        <div className=" ">
            ...
            <div style={{marginTop: 61}} className='relative'>
                ...
                <div className='justify-center items-center flex relative'>
                    ...
                    <div className='absolute top-24' style={{left: 817}}>
                ...
                <div className='justify-center items-center flex pl-20 relative' style={{marginTop: 91}}>
                    ...
                    <div className='absolute top-28' style={{left: 511}}>
                ...
                <div className='justify-center items-center flex pl-20 relative' style={{marginTop: 91}}>
                    ...
                    <div className='absolute top-24' style={{left: 850}}>
                ...
                <div className='justify-center items-center flex pl-20 relative' style={{marginTop: 91}}>
                    ...
                    <div className='absolute top-20' style={{left: 511}}>
